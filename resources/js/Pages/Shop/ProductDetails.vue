    ...
    <AppLayout>
        <div>
            <section id="SingleProduct" ref="SingleProduct" class="grid grid-cols-1 sm:grid-cols-2 py-8">
                <div class="product-images container mx-auto px-0 sm:px-8">
                    ...
                    <div class="sm:grid sm:grid-cols-3 gap-2 hidden rounded-md px-5">
                        <div class="w-auto h-36 bg-gray-200 row-span-1 col-span-1 space-y-2">
                            <img v-for="image in product.images.slice(1)" :key="image" :src="'/storage/' + image"
                                :alt="'Product Image ' + (product.images.indexOf(image) + 2)" class="h-auto overflow-hidden" />
                        </div>
                        <div class="w-auto h-auto bg-gray-200 row-span-2 col-span-2">
            ...
            <section id="RelatedProduct" class="py-12" ref="RelatedProduct">
                <div>
                    ...
                    <div class=" inline-block sm:flex flex-shrink-0 px-12 space-y-3 sm:space-y-0 space-x-0 sm:space-x-6">
