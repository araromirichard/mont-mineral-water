...
const classes = computed(() =>
    props.active
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-blue-900 text-left text-base font-medium text-blue-900 bg-gray-50 focus:outline-none focus:text-blue-900 focus:bg-gray-100 focus:border-gray-700 transition duration-150 ease-in-out'
