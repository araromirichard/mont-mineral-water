    ...
    <table class="w-full" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
            <td class="text-center py-6">
                <a href="http://localhost" class="inline-block">
                    <img src="https://laravel.com/img/notification-logo.png" class="logo" alt="Laravel Logo"
                        style="max-width: 100%; border: none; height: 75px; max-height: 75px; width: 75px;">
                </a>
            </td>
        </tr>

        <tr>
            <td class="border-t border-b" style="background-color: #edf2f7;">
                <table class="inner-body mx-auto max-w-2xl" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="px-4 py-8">
                            <h1 class="text-xl font-bold mb-4">Order Received</h1>
                            ...
                            <p class="text-base leading-relaxed mb-6">If you don't receive a call from us, please call
                                us on
